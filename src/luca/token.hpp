...
struct kw_import {
  friend std::strong_ordering operator<=>(kw_import, kw_import) = default;
};
struct kw_export {
  friend std::strong_ordering operator<=>(kw_export, kw_export) = default;
};
struct li_int {
...
using token =
    std::variant<tk::id, tk::kw_lambda, tk::kw_let, tk::kw_in, tk::kw_if, tk::kw_then, tk::kw_else, tk::kw_true,
                 tk::kw_false, tk::kw_bool, tk::kw_int, tk::kw_string, tk::kw_fix, tk::kw_type, tk::kw_of, tk::kw_match,
                 tk::kw_with, tk::kw_import, tk::kw_export, tk::li_int, tk::li_str, tk::op_plus, tk::op_minus,
